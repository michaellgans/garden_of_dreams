			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn google-button">
						<a class="text-reset text-decoration-none" href="${plant.google_url}">
					...
					<button type="button" class="btn flower-button">
						<a class="text-reset text-decoration-none" href="${plant.plantnet_url}">
